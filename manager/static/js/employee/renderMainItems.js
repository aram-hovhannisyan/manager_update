    ...
    function generateTableBody(Products, BigTables, TableRows, supplier) {
        ...
        for (let i = 0; i < Products.length; i++) {
            ...
            if (product.supplier === supplier.username) {
                ...
                tdProductName.style.display = "block";
                tdProductName.style.whiteSpace = "pre-line";
                tdProductName.textContent = product.productName.split(" ").join("\n");
